...
public class ASAV2_manager extends ASAV2_data {
	...
	public static void mt_addDog(){
		...
		if(dogCounter < 5) {
			...
			System.out.print("ENTER DOG'S GENDER [MALE/FEMALE]: ");
...
//-----------------------------------------------------------------------------------
	...
	public static void mt_addCat(){
		...
		if(catCounter  < 5) {
			...
			System.out.print("ENTER CAT'S GENDER [MALE/FEMALE]: ");
...
/*			System.out.println("MAP STILL EMPTY? "+asav2_ui.catShelterMap.isEmpty());*/
	...
	public static Map<Integer, String> mt_removeCat() {
		...
		asav2_ui.catShelterMap.remove(catSN);
		mt_viewCatShelter();
...
//-----------------------------------------------------------------------------------
	...
	public static void mt_addPar(){
		...
		if(parCounter < 5) {
			...
			System.out.print("ENTER PARROT'S GENDER [MALE/FEMALE]: ");
