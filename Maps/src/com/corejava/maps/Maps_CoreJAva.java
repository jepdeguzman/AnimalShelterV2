...
/*		for(String key : emp_map.keySet()) {
		...
		treeMap.put("A", "RENEL NYESTRO");
		
		Iterator<Map.Entry<String, String>> iteratorOfTreeMap = treeMap.entrySet().iterator();
		while(iteratorOfTreeMap.hasNext()) {
			Map.Entry<String, String> pair = iteratorOfTreeMap.next();
			System.out.print("KEY: "+pair.getKey());
			System.out.print(", VALUE: "+pair.getValue());
			System.out.println();
		}
